...
var images1 = ['Ann-dialogue1.png', 'Ann-dialogue2.png', 'Ann-dialogue3.png'];
var images = ['Ann-dialogue1.png', 'Ann-dialogue2.png', 'Ann-dialogue3.png','Ann-dialogue4.png', 'Ann-dialogue5.png', 'Ann-dialogue6.png'];
var i = 0;
var j = 0;
...
function setIMG(){
  return course.setAttribute('src', 'persona 5 ann takamaki text box/Course/' + images1[i]);
}
